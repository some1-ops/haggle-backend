...
export const PLANS: Record<string, Plan> = {
  free: {
    id: 'free',
    name: 'Bootstrapper',
    tagline: 'Learn the ropes with 3 free trial credits.',
    priceUsd: 0,
    billingPeriod: 'month',
    creditsPerMonth: 3,
  ...
  elite_standard: {
    ...
    creditsPerMonth: 50,
    channels: ['extension', 'desktop_overlay'],
    dodoProductId: dodoProducts['elite_standard'] ?? dodoProducts['elite'] ?? null,
    features: { ...baseFeaturesOff, meetingTranscription: true, undetectableTier: 'standard' },
  },
  elite: {
    id: 'elite',
    name: 'Elite Pro',
    ...
    creditsPerMonth: 150,
    channels: ['extension', 'desktop_overlay'],
    dodoProductId: dodoProducts['command'] ?? dodoProducts['elite_pro'] ?? null,
  ...
  elite_yearly: {
    ...
    creditsPerMonth: 150,
    channels: ['extension', 'desktop_overlay'],
    dodoProductId: dodoProducts['command_yearly'] ?? dodoProducts['elite_yearly'] ?? null,
    features: eliteFeatures,
  },
  command: {
    id: 'command',
